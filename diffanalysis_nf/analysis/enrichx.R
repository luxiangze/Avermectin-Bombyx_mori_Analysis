...
pdf(file=file.path(opt$outdir, paste0(file_prefix, "_go_enrichfactor.pdf")), width=13, height=8)
...
pdf(file=file.path(opt$outdir, paste0(file_prefix, "_kegg_enrichfactor.pdf")), width=13, height=6)
